...
/**
 * Navbar — kept for type-checking compatibility only.
 * The active top navigation in the SOC shell is TopHUD.tsx.
 * ReportModal has been removed from here; it is now URL-driven (?report=true).
 */
  ...
  return (
    <nav className="flex-shrink-0 h-14 bg-surface border-b border-border flex items-center px-4 gap-4 z-50">
      <Link href="/" className="flex items-center gap-2.5 flex-shrink-0 group">
        <div className="w-8 h-8 rounded-lg bg-accent flex items-center justify-center shadow-glow-orange">
