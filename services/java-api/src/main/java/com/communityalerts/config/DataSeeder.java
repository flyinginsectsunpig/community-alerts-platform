    ...
    CommandLineRunner seedData() {
        return args -> {
            ...
            incidentRepository.save(Incident.builder()
                    ...
                    .description(
                            "White Toyota Quantum with no plates. Driver watching school entrance for 20+ minutes.")
            ...
            Incident i6 = incidentRepository.save(Incident.builder()
                    ...
                    .description(
                            "Informal dwelling alight. Fire spreading to adjacent structures. Residents evacuating.")
            ...
            Incident i8 = incidentRepository.save(Incident.builder()
                    ...
                    .description(
                            "Water main burst. Municipality working on repairs. Closed between Thornton and Vanguard.")
            ...
            forumPostRepository.saveAll(List.of(
                    ForumPost.builder().suburb(khaye).username("NomthandoS").likes(24)
                            .text("The garage robbery isn't the first this month — three on Mew Way this week. We need a CPF meeting ASAP.")
                            .build(),
                    ForumPost.builder().suburb(khaye).username("XolaniM").likes(31)
                            .text("Agreed. I've been talking to the sector commander. Meeting proposed for Friday 18:00 at the community hall.")
                            .build(),
                    ...
                    ForumPost.builder().suburb(mitch).username("RasheedaN").likes(15)
                            .text("Westgate area has been bad this month. Three hijackings I know of personally.")
                            .build(),
                    ForumPost.builder().suburb(mitch).username("Deshan_M").likes(42)
                            .text("I saw the Polo on this app before they caught it. It was already reported stolen. This platform works.")
                            .build(),

                    ForumPost.builder().suburb(grassy).username("MrsJooste").likes(8)
                            .text("The Quantum outside the school was reported. Police sent a patrol car and it left immediately.")
                            .build(),

                    ForumPost.builder().suburb(obs).username("TamaraBV").likes(5)
                            .text("I can see the smoke from Woodstock. Terrible. Does anyone know if the Red Cross shelter has capacity?")
                            .build()));
