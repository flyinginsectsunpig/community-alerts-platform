...
public class IncidentController {
    ...
    @Operation(summary = "Report a new incident",
               description = "Creates a map ping and triggers a suburb heat score recalculation.")
    ...
    @GetMapping("/nearby")
    @Operation(summary = "Find incidents within a radius of a coordinate",
               description = "Uses the Haversine formula. Default radius is 2km.")
